...
local opts = {
  ...
  picker = {
    ...
    icons = {
      ...
      ui = {
        selected = Config.icons.selected,
        unselected = "  ",
      },
      diagnostics = {
      ...
      git = {
        enabled = true,
        commit = Config.icons.git_icons.commit .. " ",
        staged = Config.icons.git_icons.staged,
        added = Config.icons.git_icons.added,
        deleted = Config.icons.git_icons.deleted,
        ignored = Config.icons.git_icons.ignored,
        modified = Config.icons.git_icons.modified,
        renamed = Config.icons.git_icons.renamed,
        unmerged = Config.icons.git_icons.unmerged,
        untracked = Config.icons.git_icons.untracked,
      },
      kinds = Config.icons.lsp_mini_icons(),
    },
    layout = {
      cycle = true,
    },
    ...
    sources = {
      ...
      explorer = {
        ...
        include = { ".config", ".nvim" }, -- always include (precedence over 'exclude', 'ignored' and 'hidden')
...
vim.keymap.set("n", "<leader>sf", function()
  if Config.utils.inside_git_repo() then

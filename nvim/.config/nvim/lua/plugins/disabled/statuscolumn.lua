...
function M.get_signs(buf, lnum)
  ...
  -- legacy signs in nvim_buf_get_extmarks are included since nvim 0.10
...
function M.statuscolumn()
  ...
  local show_open_folds = false -- show fold sign when fold is open
  local use_githl = true -- show git highlight when fold
